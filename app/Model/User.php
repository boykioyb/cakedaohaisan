...
//
//            $query['conditions']['id'] = new MongoId($user['id']);
//        } elseif ($user['type'] == 'CONTENT_ADMIN') {
//
//            $query['conditions']['content_provider_code'] = $user['content_provider_code'];
//        }
//
//        return $query;
//    }
...
//        }
//
//        if (!empty($this->data[$this->alias]['service_codes'])) {
//            foreach ($this->data[$this->alias]['service_codes'] as $item) {
//                $arr = explode('_', "$item");
//                $service_codes[$arr['0']][] = $arr['1'];
//            }
//            $this->data[$this->alias]['service_codes'] = $service_codes;
//
//        }
//    }
//
...
//    }
//
//    public function getListName($options = array())
//    {
//
