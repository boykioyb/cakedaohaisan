...
<div class="ibox-content m-b-sm border-bottom">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <?php
                echo $this->Form->input('story', array(
                    'div' => false,
                    'class' => 'form-control',
                    'label' => __('stories_like'),
                    'type' => 'text',
                    'default' => $this->request->query('story'),
                ));
                ?>
            </div>
        </div>
                ...
                <thead>
                    <tr>
                        <?php if (!empty($list_data)): ?>
                            ...
                            <th style="width: 19%"><?= __('ID') ?></th>
                            <th style="width: 20%"><?php echo $this->Paginator->sort('name', __('stories_like')); ?></th>
                            <th style="width: 15%"  class="text-center"><?php echo __('post_content'); ?></th>
                        ...
                        <?php for ($i = 0; $i < count($list_data); $i++): ?>
                            <tr class="form-edit">
                                ...
                                <td>
                                    ...
                                    echo $this->Html->link(isset($id) ? $id : '', array('controller' => 'VaaStoryComments', 'action' => 'infoStory', $id));
                                    ?>
                                    <br>
                                    <small>Parent_id: <?= isset($list_data[$i][$model_name]['parent_id']) && !empty($list_data[$i][$model_name]['parent_id']) ? $list_data[$i][$model_name]['parent_id'] : 0 ?></small>
                                </td>
                                <td>
                                    <?php if (isset($story[$i]['id'])): ?>
                                        <?php
                                        echo $this->Html->link(isset($story[$i]['content']) ? $story[$i]['content'] : 'empty', array('controller' => 'VaaStories', 'action' => 'infoStory', isset($story[$i]['id']) ? $story[$i]['id'] : ''));
                                        ?>
                                        <hr style="margin-top:6px;margin-bottom: 6px">
                                    <?php endif; ?>
                                    <small>ID: <?= isset($story[$i]['id']) ? $story[$i]['id'] : '0' ?></small>
                                </td>

                                <td>
                                    <?= isset($list_data[$i][$model_name]['content']) ? $list_data[$i][$model_name]['content'] : '' ?>
                                </td>
                                <td>
