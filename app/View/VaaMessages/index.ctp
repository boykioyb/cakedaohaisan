                    ...
                    <?php if (!empty($list_data)): ?>
                        ...
                        <?php for ($i = 0; $i < count($list_data); $i++): ?>
                            <tr class="form-edit">
                                ...
                                <td>
                                    <strong>
                                        <?php echo $this->Html->link(isset($id) ? $id : '', array('controller' => 'VaaMessages', 'action' => 'infoMessage', $id)); ?>
                                    </strong><br>
                                </td>
                                <td>
                                    <strong>
                                        <?php echo $this->Html->link(isset($list_data[$i][$model_name]['room']) ? $list_data[$i][$model_name]['room'] : '', array('controller' => 'VaaRooms', 'action' => 'infoRoom', $list_data[$i][$model_name]['room'])); ?>
                                    </strong><br>
                                </td>
                                <td><?= isset($list_data[$i][$model_name]['type']) ? $list_data[$i][$model_name]['type'] : '0'; ?></td>
                                <td><?= isset($list_data[$i][$model_name]['content']) ? $list_data[$i][$model_name]['content'] : 'empty'; ?></td>
                                <td>
