    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo __('user_group_home_url') ?> <?php echo $this->element('required') ?></label>

                    <div class="col-sm-10">
                        <?php
                        echo $this->Form->input($model_name . '.home_url', array(
                            'class' => 'form-control home_url',
                            'div' => false,
                            'label' => false,
                            'required' => true,
                            'options' => $group_permissions,
