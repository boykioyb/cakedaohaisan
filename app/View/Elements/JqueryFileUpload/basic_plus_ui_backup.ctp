...
$default_upload_options = array(
    ...
    'maxFileSize' => Configure::read('sysconfig.App.max_file_size_upload'),
);
...
?>
<div class="fileupload-container <?php echo $required_clss ?> <?php echo $validate_error_clss ?>">
                            ...
                            <tr class="template-download fade in">
                                <td>
                                    <span class="preview">
                                        <?php if ($image_type !== false): ?>
                                            ...
                                            <a class="<?php echo $playerPreview ?>" href="<?php echo $file_url; ?>"
                                               title="<?php echo $file_name ?>"
                                               download="<?php echo $file_name ?>" <?php echo $data_gallery ?>>
                                                <img src="<?php echo $file_url ?>" class="img-responsive img-thumbnail">
                                            </a>
                                        <?php elseif (!empty($video_data_attr)): ?>
                                            <a class="<?php echo $playerPreview ?>" href="<?php echo $file_url; ?>"
                                               title="<?php echo $file_name ?>"
                                               download="<?php echo $file_name ?>" <?php echo $data_gallery ?> <?php echo $video_data_attr ?>>
                                            </a>
                                        <?php else : ?>
                                            <a class="<?php echo $playerPreview ?>" href="<?php echo $file_url; ?>"
                                               title="<?php echo $file_name ?>"
                                ...
                                <td>
                                    <p class="name">
                                        ...
                                        <?php endif; ?>
                                        <input type="hidden" class="file-hidden <?php echo $class ?>"
                                               name="<?php echo $name ?>" value='<?php echo $fileSerialize ?>'/>
                                    </p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php if (!empty($file_delete_url)): ?>
                                        <button class="btn btn-danger delete" data-type="delete"
                                                data-url="<?php echo $file_delete_url ?>">
                                            <i class="glyphicon glyphicon-trash"></i>
                                            <span><?php echo __('delete') ?></span>
                                        </button>
...
<div id="blueimp-gallery-<?php echo $dom_id ?>" class="blueimp-gallery blueimp-gallery-carousel" data-filter=":even"
...
<script id="<?php echo $template_download_id ?>" type="text/x-tmpl">
    ...
    <a class="<?php echo $playerPreview ?>
    " href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery="#blueimp-gallery-<?php echo $dom_id ?>"><img src="{%=file.thumbnailUrl%}"></a>
    {% } %}
    </span>
    </td>
    <td>
    ...
    {% if (file.url) { %}
    <a class="<?php echo $playerPreview ?>
    " href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" {%=file.thumbnailUrl?'data-gallery="#blueimp-gallery-<?php echo $dom_id ?>"':''%}>{%=file.name%}</a>
    {% } else { %}
    <span>{%=file.name%}</span>
    {% } %}
