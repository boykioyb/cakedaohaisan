...
$default_upload_options = array(
    ...
    'maxFileSize' => Configure::read('sysconfig.App.max_file_video_size_upload'),
);
            ...
            <tbody class="files">
                ...
                <?php if (!empty($request_data_file)): ?>
                    ...
                    <?php foreach ($request_data_file as $file): ?>
                        <?php
                        if (is_string($file) && !empty(json_decode($file, true))) {
                            $file = json_decode($file, true);
                        }
//                        if (!empty($file) && is_array($file)):
                        if (!empty($file)):
                            if (is_array($file)) {
                                $file_uri = isset($file['url']) ? ltrim($file['url'], APP) : '';
                                $file_url = isset($file['url']) ? $file['url'] : '';
                                $file_name = isset($file['name']) ? $file['name'] : '';
                            } else {
                                $file_uri = ltrim($file, DS);
...
<!--                                                <img src="<?php //echo $file_url ?>" class="img-responsive img-thumbnail">-->
                                                <video src="<?php echo $file_url ?>" controls=""></video>
                                            </a>
