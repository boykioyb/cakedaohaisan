                ...
                <thead>
                    <tr>
                        <?php if (!empty($list_data)): ?>
                            ...
                            <th style="width: 12%"><?php echo __('stories_feeling'); ?></th>
                    ...
                    <?php if (!empty($list_data)): ?>
                        ...
                        <?php for ($i = 0; $i < count($list_data); $i++): ?>
                            <tr class="form-edit">
                                ...
                                <td>
                                    <strong>
                                        <?php echo $this->Html->link(isset($list_data[$i][$model_name]['content']) ? $list_data[$i][$model_name]['content'] : '', array('controller' => 'VaaStories', 'action' => 'infoStory', $id)); ?>
                                    </strong><br>
                                ...
                                <?php $id_feeling = (string) $list_data[$i][$model_name]['feeling']; ?>
                                <td><?= isset($list_data[$i][$model_name]['feeling']) ? $feeling[$id_feeling]['vi']['name'] : ''; ?> </td>
