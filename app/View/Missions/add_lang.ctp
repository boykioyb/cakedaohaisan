            ...
            <div class="row panel-container">
                <div class="form-horizontal">
                    ...
                    <div class="form-group <?php $name_err_class?>">
                        <label class="col-sm-2 control-label"><?php echo __('name_mission') ?> <?php echo $this->element('required') ?></label>
                    ...
                    <div class="form-group<?php echo $name_err_class ?>">
                        <label class="col-sm-2 control-label"><?php echo __('Alias') ?></label>
