                ...
                <thead>
                    <tr>
                        <?php if (!empty($list_data)): ?>
                            ...
                            <th style="width: 5%"><?php echo $this->Paginator->sort('name', __('post_discussion')); ?></th>
                        ...
                        <?php for ($i = 0; $i < count($list_data); $i++): ?>
                            <tr class="form-edit">
                                ...
                                <td>
                                    ...
                                    echo $this->Html->link(isset($id) ? $id : '', array('controller' => 'VaaPostComments', 'action' => 'infoPost', $id));
                                    ?>
                                    <br>
            ...
            swal({
                ...
                closeOnCancel: true
                    ...
                    .then((isConfirm) => {
                        if (isConfirm) {
                            $.ajax({
                                url: '<?= Router::url(['controller' => 'VaaPostComments', 'action' => 'ajaxChangeStatus']) ?>',
                                type: 'post',
                                dateType: 'json',
                                data: {
                                    status: status,
