    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo __('Parent ID') ?></label>
                    <div class="col-sm-10">
                        <?php
                        echo $this->Form->input($model_name . '.parentid', array(
                            'class' => 'form-control',
                            'div' => false,
                            'label' => false,
                            'readonly' => 'readonly',
                            'value' => isset($post[$model_name]['parent_id']) ? $post[$model_name]['parent_id'] : ''
                        ));
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php
                        echo $this->Form->input($model_name . '.post_content', array(
                            'class' => 'form-control',
                            'div' => false,
                            'label' => false,
                            'readonly' => 'readonly',
                            'value' => isset($post[$model_name]['content']) ? $post[$model_name]['content'] : ''
                        ));
                        ?>
                    </div>
                </div>
