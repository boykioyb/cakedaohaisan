        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div id="wrap-add-lang">
                    <?php if(isset($this->request->data['Region']) && count($this->request->data['Region']) > 0){  ?>
                        <?php foreach($this->request->data['Region'] as $data_key => $data_value){
                            if(isset($langCodes[$data_key]) && !empty($data_value)){
                                echo $this->element('../Regions/add_lang', array('lang_code' => $data_key, 'country' => $langCodes[$data_key], 'request_data' => $data_value));
                                ?>
                            <?php }
                        } ?>
                    <?php } ?>
...
<!--                <div class="form-group">-->
<!--                    <label class="col-sm-2 control-label">--><?php //echo __('region_parent_id') ?><!--</label>-->
<!---->
<!--                    <div class="col-sm-10">-->
<!--                        --><?php
...
<!--                </div>-->
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo __('Code') ?></label>
