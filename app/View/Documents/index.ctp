            ...
            <table class="table table-striped">
                ...
                <tr>
                    <?php if (!empty($list_data)): ?>
                        ...
                        <th style="width: 20%"><?php echo $this->Paginator->sort('name', __('blog_name')); ?></th>
                        <th style="width: 20%"><?php echo 'Danh mục' ?></th>
                    ...
                    <?php foreach ($list_data as $item): ?>
                        <tr class="form-edit">
                            ...
                            <td>
                                <?php
                                echo
                                $this->Form->input('categories', array(
                                    'div' => false,
