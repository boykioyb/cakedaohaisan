                ...
                <thead>
                    <tr>
                        ...
                        <?php else: ?>
                            <th style="width: 3%"><?= __('STT') ?></th>
                            <th style="width: 15%"><?= __('ID') ?></th>
                            <th style="width: 15%"><?php echo $this->Paginator->sort('name', __('stories_like')); ?></th>
                            <th style="width: 10%"><?php echo(__('owner')); ?></th>
                            <th style="width: 8%"><?php echo __('status') ?></th>
                            <th style="width: 10%"><?php echo __('created_date') ?></th>
                        <?php endif; ?>
                        ...
                        <?php for ($i = 0; $i < count($list_data); $i++): ?>
                            <tr class="form-edit">
                                ...
                                <td>
                                    ...
                                    echo $this->Html->link(isset($id) ? $id : '', array('controller' => 'VaaStoryShares', 'action' => 'infoStory', $id));
                                    ?>
                                </td>
                                ...
                                <td>
                                    <?php if (isset($story[$i]['id'])): ?>
                                        <?php
                                        echo $this->Html->link(isset($story[$i]['content']) ? $story[$i]['content'] : '', array('controller' => 'VaaStories', 'action' => 'infoStory', isset($story[$i]['id']) ? $story[$i]['id'] : ''));
                                        ?>
            ...
            swal({
                ...
                closeOnCancel: true
                    ...
                    .then((isConfirm) => {
                        if (isConfirm) {
                            $.ajax({
                                url: '<?= Router::url(['controller' => 'VaaStoryShares', 'action' => 'ajaxChangeStatus']) ?>',
                                type: 'post',
                                dateType: 'json',
                                data: {
                                    status: status,
