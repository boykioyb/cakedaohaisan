            ...
            <div class="ibox-content">
                <div class="tabs-container">
                    ...
                    <div id="wrap-add-lang">
                        <?php if (isset($this->request->data['News']) && count($this->request->data['News']) > 0) { ?>
                            <?php
                            foreach ($this->request->data['News'] as $data_key => $data_value) {
                                if (isset($lang_configs[$data_key]) && !empty($data_value['name'])) {
                                    echo $this->element('../News/add_lang', array('lang_code' => $data_key, 'country' => $lang_configs[$data_key], 'request_data' => $data_value));
                                }
                            }
                            ?>
                        <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label><?php echo 'Kích thước ảnh phù hợp: 100x70px' ;?></label>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label><?php echo 'Kích thước ảnh phù hợp: 570x470px' ;?></label>
                            <?php
                            echo $this->element('JqueryFileUpload/basic_plus_ui', array(
