    ...
    public function add() {
        ...
        $this->set([
            'breadcrumb' => [
                array(
                    'url' => Router::url(array('action' => 'index')),
                    'label' => __('Nhiệm vụ của hiệp hội'),
                ),
                array(
...
//        $this->checkAuth();
    ...
    protected function setInit() {
        ...
        $this->set('status', Configure::read('sysconfig.App.status_missions'));
        $this->set('languages', Configure::read('sysconfig.App.languages'));
        $this->set('page_title', __('Nhiệm vụ của hiệp hội'));
        $lang_code = $this->Session->read('lang_code');
        if ((empty($lang_code))) {
            $lang_code = Configure::read('S.Lang_code_default');
        }
