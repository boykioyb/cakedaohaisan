...
class VaaStoryLikesController extends AppController {
        ...
        $this->set([
            'breadcrumb' => [
                array(
                    ...
                    'label' => __('stories_like_title_index'),
                )
            ],
            'list_data' => $list_data,
    ...
    public function infoStory($id = null) {
        ...
        $this->set([
            'breadcrumb' => [
                array(
                    'url' => Router::url(array('action' => 'index')),
                    'label' => __('stories_like_title_info'),
                )
            ]
        ]);
    ...
    protected function setInit() {
        ...
        $this->set('page_title', __('stories_like_title_index'));
    }
