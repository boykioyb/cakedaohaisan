...
class VaaMessagesController extends AppController {
    ...
    public function infoMessage($id = null) {
        $this->checkAuth();
        ...
        $getIdPushTo = !empty($room[$this->modelClass]['push_to']) ? $room[$this->modelClass]['push_to'] : [];
        $extract_push_to = Hash::extract($getIdPushTo, '{n}.$id');

        $getIdSeenBy = !empty($room[$this->modelClass]['seen_by']) ? $room[$this->modelClass]['seen_by'] : [];
        $extract_seen_by = Hash::extract($getIdSeenBy, '{n}.$id');
        ...
        $this->set([
            ...
            'value_push_to' => $extract_push_to,
            'value_seen_by' => $extract_seen_by,
    ...
    protected function setInit() {
        ...
        $this->set('page_title', __('message_title_index'));
    }
